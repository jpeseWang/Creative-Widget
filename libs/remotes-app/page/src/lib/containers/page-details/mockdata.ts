          ...
          <div class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-h-1 sm:aspect-w-1 sm:row-span-2">
            ...
            <div class="flex items-end p-6">
              <div>
                ...
                <p aria-hidden="true"
                   class="mt-1 text-sm text-white">Shop now</p>
              </div>
            </div>
          </div>
...
export const DATA_SIDE_BAR = [
  ...
  <div class="py-8 sm:py-24 xl:mx-auto xl:max-w-7xl xl:px-8">
  ...
  {
    preview: 'https://via.placeholder.com/300',
    src: `<div><footer class="bg-white" aria-labelledby="footer-heading">
...
//<cwp-component.. type="header-1" ></cwp-component..>
